  ...
  return (
    <motion.button
      ...
      className={`login-role-card ${
        active
          ? isAdmin
            ? 'login-role-card--admin-active'
            : 'login-role-card--contrib-active'
    ...
    >
      ...
      {active && (
        <motion.div
          layoutId="roleActive"
          className={`login-role-active-dot ${
            isAdmin
              ? 'login-role-active-dot--admin'
              : 'login-role-active-dot--contrib'
          }`}
          transition={{
            type: 'spring',
            stiffness: 300,
    ...
    <div className="login-page">
      ...
      <div className="login-split">
        ...
        >
          ...
          <div className="login-left-hero">
            ...
            >
              ...
              <h1
                className={`login-left-title ${
                  isAdmin
                    ? 'login-left-title--admin'
                    : 'login-left-title--contrib'
                }`}
              >
                {isAdmin
                  ? 'Manage Heritage,'
            ...
            <ul className="login-features">
              ...
              {(isAdmin
                ...
                : [
                    'Submit new heritage sites',
                    'Upload photos & oral histories',
                ...
                >
                  <span
                    className={`login-feature-dot ${
                      isAdmin
                        ? 'login-feature-dot--admin'
                        : 'login-feature-dot--contrib'
                    }`}
                  />
          ...
          <div
            className={`login-mandala ${
              isAdmin
                ? 'login-mandala--admin'
                : 'login-mandala--contrib'
            }`}
          />
            ...
            <div className="login-card-header">
              ...
              <div
                className={`login-card-icon ${
                  isAdmin
                    ? 'login-card-icon--admin'
                    : 'login-card-icon--contrib'
                }`}
              >
                {isAdmin ? (
                  <Fingerprint size={28} />
                ...
                {isAdmin ? (
                  ...
                  >
                    ...
                    <div className="login-forgot">
                      ...
                      <a
                        href="#"
                        className="login-forgot-link login-forgot-link--admin"
                      >
                        Forgot password?
                      </a>
                  ...
                  >
                    ...
                    <div className="login-forgot">
                      ...
                      <a
                        href="#"
                        className="login-forgot-link login-forgot-link--contrib"
                      >
                        Forgot password?
                      </a>
